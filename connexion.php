...
<head>
    <title>Connexion | Descartes park</title>
        ...
        <?php
            ...
            if (isset($_SESSION['id']) AND isset($_SESSION['identifiant'])) {
                ...
                ?>
                    ...
                    <section class="form-log-in" id="form-sign-in">
                        <div class="form-log-incontent" align="center">
                            <h2 class="text4 gras">Connexion</h2>
                            <br>
                            <form class="form-ins" method="post">
                                ...
                                <br>
                                <p>
                                    <input type="submit" name="btn-valider" id="btn-valider" value="Se connecter">
                                </p>
                            </form>
                            <br>
                            <?php echo $msg; ?>
                            <br>
                            <p class="text1" align="center">Vous n'ête pas encore inscris ? <span><a href="inscription.php" class="bleu nosoulignes">S'inscrire</a></span></p>
                        </div>                        
                    </section>  
